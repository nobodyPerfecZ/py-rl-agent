...
class TestRolloutBufferNumpy(unittest.TestCase):
    """Tests the class RolloutBuffer() with numpy arrays."""
...
class TestRolloutBufferTorch(unittest.TestCase):
    """Tests the class RolloutBuffer() with torch tensors."""

...
class TestNetwork(unittest.TestCase):
    ...
    def test_mlp(self):
        ...
        linear1, activation1, linear2, activation2, linear3, activation3 = mlp_net[:6]
    ...
    def test_cnn(self):
        ...
        conv1, pooling1, activation1, conv2, pooling2, activation2, flatten = cnn_net[
            :7
        ]
    ...
    def test_cnn_mlp(self):
        """Tests the cnn_mlp() method."""
        ...
        linear1, activation3, linear2, activation4 = mlp_net[:4]
